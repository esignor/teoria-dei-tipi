...
\begin{prooftree}
\AxiomC{$\beta$ type [$\Gamma$]}
\AxiomC{$\gamma$ type [$\Gamma$]}
\LeftLabel{F-$+$)}
\BinaryInfC{B $\vee$ C type [$\Gamma$]}
\end{prooftree}
...
\LeftLabel{E$_{dip}$-$+$)}
\TrinaryInfC{\cancel{El$_+$(z,e$_B$,e$_C$)} $\in$ $\xi$ vero[$\Gamma$,z $\in$ B $\vee$ C vero]}
\end{prooftree}
...
\AxiomC{$\gamma$ + $\gamma$ type[$\Gamma$]}
\LeftLabel{I$_1$-$+$)}
\BinaryInfC{inl(b) $\in$ $\beta$ $\vee$ $\gamma$[$\Gamma$]}
\end{prooftree}
...
\AxiomC{$\gamma$ + $\gamma$ type[$\Gamma$]}
\LeftLabel{I$_1$-$+$)}
\BinaryInfC{inr(c) $\in$ $\beta$ $\vee$ $\gamma$[$\Gamma$]}
\end{prooftree}
