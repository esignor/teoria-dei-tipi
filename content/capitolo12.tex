...
Questo perch\`e N$_0$ $\equiv$ $\bot$ e Id(Nat,0,1) $\equiv$ $\neg0$ $=_{Nat}$ 1\\
...
\begin{center}isZero(z)[z $\in$ Nat]\end{center}
...
\end{itemize}
\noindent
\textit{\`E vero che z \`e zero, percui nel caso base va messo N$_1$\\
...
\noindent
\normalsize
Dunque verifico che z $=$ 0 $\in$ N$_1$ (\textit{per farlo uso la regola di Conversione dei Naturali})
