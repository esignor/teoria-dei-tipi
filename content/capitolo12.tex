...
\LeftLabel{F-Uno}
\UnaryInfC{U$_0$ type[z $\in$ Id(Nat,0,1)]}
\LeftLabel{ref}
\UnaryInfC{U$_0$ $=$ U$_0$ type[z $\in$ Id(Nat,0,1)]}
\end{prooftree}
\end{adjustwidth}
...
\normalsize \textbf{2}\\\\
\textit{isZero}(0) $=$ $\hat{N}_1$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)] $\equiv$ El$_{Nat}$(0, $\hat{N}_1$,(x,y).$\hat{N}_0$) $=$ $\hat{N}_1$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]
\scriptsize
...
\UnaryInfC{z $\in$ Id(Nat,0,1) cont}
\LeftLabel{I$_2$-Uno}
\UnaryInfC{$\hat{N}_1$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]}
\AxiomC{\textbf{($\ast$)}}
\UnaryInfC{z $\in$ Id(Nat,0,1) cont}
\LeftLabel{F-Nat}
\UnaryInfC{Nat type[z $\in$ Id(Nat,0,1)]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(x $\in$ Nat) $\notin$ \\ z $\in$ Id(Nat,0,1)\end{tabular}}
\UnaryInfC{z $\in$ Id(Nat,0,1), x $\in$ Nat cont}
\LeftLabel{F-Uno}
\UnaryInfC{U$_0$ type[z $\in$ Id(Nat,0,1), x $\in$ Nat]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(y $\in$ U$_0$) $\notin$  (z $\in$ \\ Id(Nat,0,1), x $\in$ Nat)\end{tabular}}
\UnaryInfC{z $\in$ Id(Nat,0,1), x $\in$ Nat, y $\in$ U$_0$ cont}
\LeftLabel{I$_1$-Uno}
\UnaryInfC{$\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1), x $\in$ Nat, y $\in$ U$_0$]}
\LeftLabel{C$_1$-Nat}
\TrinaryInfC{El$_{Nat}$(0, $\hat{N}_1$,(x,y).$\hat{N}_0$) $=$ $\hat{N}_1$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]}
\end{prooftree}
\end{adjustwidth}
\noindent

\normalsize \textbf{3}\\\\
\textit{isZero}(1) $=$ $\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)] $\equiv$ El$_{Nat}$(succ(0), $\hat{N}_1$,(x,y).$\hat{N}_0$) $=$ $\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]
\scriptsize
...
\UnaryInfC{z $\in$ Id(Nat,0,1) cont}
\LeftLabel{I$_1$ Nat}
\UnaryInfC{0 $\in$ Nat [z $\in$ Id(Nat,0,1)]}
\AxiomC{\textbf{($\ast$)}}
\UnaryInfC{U$_0$ type [z $\in$ Id(Nat,0,1)]}
\AxiomC{\textbf{($\ast$)}}
\UnaryInfC{z $\in$ Id(Nat,0,1) cont}
\LeftLabel{I$_1$-Uno}
\UnaryInfC{$\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]}
\AxiomC{\textbf{($\ast$)}}
\UnaryInfC{$\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1), x $\in$ Nat, y $\in$ U$_0$]}
\LeftLabel{C$_2$-Nat}
\QuaternaryInfC{El$_{Nat}$(succ(0), $\hat{N}_1$,(x,y).$\hat{N}_0$) $=$ $\hat{N}_0$ $\in$ U$_0$ [z $\in$ Id(Nat,0,1)]}
\end{prooftree}
\end{adjustwidth}
\vspace{0.3cm}
\noindent
