...
\end{enumerate}
\noindent
Dunque \textit{isZero}(z) equivale a El$_{Nat}$(z,$\hat{N}_1$,(x,y).$\hat{N}_0$)\\
con \textit{isZero}(0) $=$ $\hat{N}_1$ $\in$ U$_0$[ ] e \textit{isZero}(1) $=$ $\hat{N}_0$ $\in$ U$_0$[ ]
...
Inoltre visto che \textit{isZero}(0) $=$ N$_1$ e \textit{isZero}(1) $=$ N$_0$ anche h$_{isZero}$(0,1,z) Id(U$_0$,N$_1$,N$_0$)[z $\in$ Id(Nat,0,1)] \`e derivabile.
\small
\begin{adjustwidth}{-9.5em}{}
\begin{prooftree}
...
\noindent
q$_{U_0}$(x,y,z) $\in$ (T(x) $\rightarrow$ T(y)) $\times$ (T(y) $\rightarrow$ T(x))[x $\in$ U$_0$,y $\in$ U$_0$,z $\in$ Id(U$_0$,x,y)] \`e derivabile, equivalente a El$_{Id}$(z,(x).$<\lambda$x.w,$\lambda$w.w$>$) $\in$ (T(x) $\rightarrow$ T(x)) $\times$ (T(x) $\rightarrow$ T(x)).\\
(T(x) $\rightarrow$ T(x)) $\times$ (T(x) $\rightarrow$ T(x)) perch\`e M(z$_1$,z$_2$,z$_3$) $\equiv$ (T(z$_1$) $\rightarrow$ T(z$_2$)) $\times$ (T(z$_2$) $\rightarrow$ T(z$_1$)) e M(x,x,id(x)) $\equiv$ (T(x) $\rightarrow$ T(x)) $\times$ (T(x) $\rightarrow$ T(x)).
\subsubsection{Corollario}
Da q$_{U_0}$(x,y,z) $\in$ (T(x) $\rightarrow$ T(y)) $\times$ (T(y) $\rightarrow$ T(x))[x $\in$ U$_0$,y $\in$ U$_0$,z $\in$ Id(U$_0$,x,y)] sostituendo x con N$_1$ e y con N$_0$ ottengo \begin{center} q$_{U_0}$($\hat{N_1}$,$\hat{N_0}$,z) $\in$ (T(N$_1$) $\rightarrow$ T(N$_0$)) $\times$ (T(N$_1$) $\rightarrow$ T(N$_0$))[z $\in$ Id(Nat,0,1)] \end{center} che \`e derivabile.
