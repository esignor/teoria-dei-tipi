...
\TrinaryInfC{$<\lambda$ $x.\pi_1$($Ap(z,x)$), $\lambda$ $x.\pi_2$($Ap(z,x)$)$>$ $\in$ $\sum_{f \in A \rightarrow B}$ $\prod_{x \in A}$ $R(x,f(x))$ [$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)]$}
...
\UnaryInfC{$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$ cont}
\LeftLabel{ind-ty}
\BinaryInfC{A type[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$)]}
\LeftLabel{F-c}\RightLabel{(x $\in$ A) $\in$ ($\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$)}
\UnaryInfC{$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A cont}
\LeftLabel{var}
\UnaryInfC{z $\in$ $\prod_{x \in A}$ $\sum_{y \in B}R(x,y)$[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A]}
\AxiomC{(\textbf{$\ast$})}
\UnaryInfC{$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A cont}
\LeftLabel{var}
\UnaryInfC{$x \in A $[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A]}
\LeftLabel{E-{\scriptsize$\prod$}}
\BinaryInfC{$Ap(z,x)$ $\in$ $\sum_{y \in B}R(x,y)$[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A]}
\LeftLabel{PJ$_1$-x}
\UnaryInfC{$\pi_1$($Ap(z,x)$) $\in$ B[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$,x $\in$ A]}
\LeftLabel{I-$\rightarrow$}
\UnaryInfC{$\lambda$ $x.\pi_1$($Ap(z,x)$) $\in$ A $\rightarrow$ B[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)$]}
\end{prooftree}
\end{adjustwidth}
...
\begin{prooftree}
\AxiomC{}
\UnaryInfC{$\lambda$ $x.\pi_2$($Ap(z,x)$) $\in$ $\prod_{x \in A}$ R(x,Ap($\lambda$ $x.\pi_1$($Ap(z,x)$),x))[$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)]$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{}
\UnaryInfC{$\sum_{f \in A \rightarrow B}$ $\prod_{x \in A}$ $R(x,f(x))$ [$\Gamma$,z $\in$ $\prod_{x \in A}$ $\sum_{y \in B} R(x,y)]$}
\end{prooftree}
\noindent
\normalsize
