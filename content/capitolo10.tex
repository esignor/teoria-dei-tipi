...
\\\\
\noindent
Devo verificare che pf $\in$ $\forall_{x \in A}$ $\exists_{y \in B}$ $\rightarrow$ $\exists_{f \in A \rightarrow B}$ $\forall_{x \in A}$ $R(x,f(x)$) [$\Gamma$]\\
Applico la formula ($\varphi$ $\rightarrow$ $\psi$)$^I$[$\Gamma$] ${\overset{\mathit{def}}{\equiv}}$ $\prod_{x \in \varphi^I}$ $\psi^I$ type[$\Gamma$]:\\\\
\noindent
$\Rightarrow$ pf $\in$ $\prod_{z \in (\prod x \in A \hspace{0.3cm} \sum y \in B R(x,y))}$ $\rightarrow$ $\sum_{f \in A \rightarrow B}$ $\prod_{x \in A}$ $R(x,f(x))$ [$\Gamma$]\\\\
\noindent
...
\begin{itemize}
\item prima applicazione, considerando $\prod_{z \in (\prod x \in A \hspace{0.3cm} \sum y \in B R(x,y))}$ C(z) [$\Gamma$]: $\lambda$z.c(z)
\item seconda applicazione considerando $\prod_{z \in (\prod x \in A \hspace{0.3cm} \sum y \in B R(x,y))}$ $\sum_{f \in A \rightarrow B}$ C(z) [$\Gamma$]: $\lambda$z.$<Ap(z,x)>$.c(z)
\item terza applicazione, considerando $\prod_{z \in (\prod x \in A \hspace{0.3cm} \sum y \in B R(x,y))}$ $\rightarrow$ $\sum_{f \in A \rightarrow B}$ $\prod_{x \in A}$ $R(x,f(x))$ [$\Gamma$]: $\lambda$z.$<\lambda x.Ap(z,x)>$
\item quarta applicazione, applico le proiezioni sulla somma indiciata, percui $\lambda$z.$<\pi_1 z(\lambda x.Ap(z,x)), \pi_2 z(\lambda x.Ap(z,x))>$
\end{itemize}
