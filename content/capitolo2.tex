...
La chiusura riflessiva, simmetrica e transitiva delle derivazioni \`e proprio l'uguaglianza definizionale. Tale propriet\`a non vale esclusivamente per $\rightarrow_1$ ma per qualsiasi combinazione delle riduzioni in \S\ref{sec: semantica-operazionale-singoletto}, con  variazione per\`o delle forma normali (che non sono altro che i risultati dei nostri programmi, derivanti dai diversi cammini di computazione).\\
