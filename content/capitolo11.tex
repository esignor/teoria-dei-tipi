...
\\\\\\
\noindent
Supposto che $\varphi$ type[$\Gamma$] sia derivabile e $\Gamma$ $\equiv$ [ ], allora
\begin{prooftree}
\AxiomC{}
...
e $\Gamma$ $\equiv$ w $\in$ $\varphi(0)$, k $\in$ $\prod_{x \in Nat}(\prod_{s \in \varphi(x)}\varphi(succ(x)))$,
 allora
\small
...
\AxiomC{}
\UnaryInfC{$\prod_{x \in Nat}(\prod_{s \in \varphi(x)}\varphi(succ(x)))$ type[$\Gamma$]}
\LeftLabel{F-{$\times$}}
\BinaryInfC{$\varphi(0) \times \prod_{x \in Nat}(\prod_{s \in \varphi(x)}\varphi(succ(x)))$ type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(y $\in$ $(\varphi(0) \times \prod_{x \in Nat}$ \\$(\prod_{s \in \varphi(x)}\varphi(succ(x))))$) $\notin$ $\Gamma$\end{tabular}}
...
\noindent
\\\\
Supposto che $\ast$ appartenga a $\varphi(\ast)$ per costruzione, $\varphi$(z) type[$\Delta$, z $\in$ N$_1$] sia derivabile e $\Gamma$ $\equiv$ [ ], allora
\begin{prooftree}
\AxiomC{}
...
$\lambda z$.El$_{List}$(z,c,(Ap(Ap(Ap(k,x),w),y)) $\in$ {\small $\prod_{z \in  List(A)}$} $\varphi(z)$ [$\Gamma$, z$^{\backprime\backprime}$ $\in$ $(\varphi(nil)$ $\times$ ${\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w))))$]\\
Applico \textit{(I-{\scriptsize $\prod$})} e ottengo \\
El$_{List}$(z,c,Ap(Ap(Ap(k,x),w),y)) $\in$ $\varphi(z)$ [$\Gamma$, z$^{\backprime\backprime}$ $\in$ $(\varphi(nil)$ $\times$ ${\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w))))$, z $\in$ List(A)]\\
\\\\
\noindent
...
e $\Gamma$ $\equiv$ c $\in$ $\varphi(nil)$, k $\in$ ${\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w))))$, 
 allora
\scriptsize
...
\begin{prooftree}
\AxiomC{}
\UnaryInfC{$\varphi(nil)$ type[$\Gamma$]}
\AxiomC{}
\UnaryInfC{${\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w)))$ type[$\Gamma$]}
\LeftLabel{F-{$\times$}}
\BinaryInfC{$\varphi(nil) \times {\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w)))$ type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(z$^{\backprime\backprime}$ $\in$ $(\varphi(nil) \times {\scriptsize \prod_{x \in List(A)}}$ \\$ {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w)))$) $\notin$ $\Gamma$ \end{tabular}}
\UnaryInfC{$\Delta$ cont}
\LeftLabel{var}
\UnaryInfC{c $\in$ $\varphi(nil)$[$\Delta$]}
...
e $\Gamma$ $\equiv$ k $\in$ $\prod_{x_1 \in B} \varphi(inl(x_1))$, w $\in$ $\prod_{x_2 \in C} \varphi(inr(x_2)))$, allora
\small
...
\noindent
Supposto che $\varphi$(z) type[$\Delta$, z $\in$ {\scriptsize  $\sum_{x \in B} C(x)$}], C(x) type[$\Delta$, x $\in$ B] siano derivabili e e $\Gamma$ $\equiv$ [ ], allora
\small
...
\\\\\\
Supposto che $\varphi(z_1,z_2,z_3)$ [$\Delta$, z$_1$ $\in$ A, z$_2$ $\in$ A, z$_3$ $\in$ Id(A,z$_1$,z$_2$)] e  A type[$\Delta$] siano derivabili e e $\Gamma$ $\equiv$ [ ], allora
\small
