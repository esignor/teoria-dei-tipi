...
$\equiv$ $\varphi$(0) $\times$ $\prod_{x \in Nat}$ ($\prod_ {z \in \varphi(x)}$ $\varphi(succ(x))$) $\rightarrow$ $\prod_{z \in Nat}$($\varphi(z)$) true [$\Gamma$]\\
$\equiv$ $\prod_{z \in(\varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} (\prod_ {z \in \varphi(x)} \varphi(succ(x))))}$ $\prod_{z \in Nat}$($\varphi(z)$) true [$\Gamma$]\\

$\Rightarrow$ Devo verificare che pf $\in$ $\prod_{z \in(\varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} (\prod_ {z \in \varphi(x)} \varphi(succ(x))))}$ $\prod_{z \in Nat}$($\varphi(z)$)[$\Gamma$] sia derivabile in teoria dei tipi.\\
...
\AxiomC{}
\UnaryInfC{$\varphi(x)$ type[$\Gamma$]}
\AxiomC{}
\UnaryInfC{$\varphi(succ(x))$ type[$\Gamma$,$z \in \varphi(x)$]}
\LeftLabel{F-{\scriptsize}$\prod$}
\BinaryInfC{$\prod_ {z \in \varphi(x)} \varphi(succ(x))$ type[$\Gamma$]}
...
\LeftLabel{ind-ty}
\BinaryInfC{$\prod_ {z \in \varphi(x)} \varphi(succ(x))$ type[$\Gamma$, x $\in$ Nat]}
\LeftLabel{I-{\scriptsize}$\prod$}
\BinaryInfC{$\prod_{x \in Nat} \prod_ {z \in \varphi(x)} \varphi(succ(x))$ type[$\Gamma$]}
\LeftLabel{F-x}
\BinaryInfC{$\varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} \prod_ {z \in \varphi(x)} \varphi(succ(x))$ type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{(z $\in \varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} \prod_ {z \in \varphi(x)} \varphi(succ(x)))$ $\notin$ $\Gamma$}
\UnaryInfC{$\Gamma$,z $\in \varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} \prod_ {z \in \varphi(x)} \varphi(succ(x))$ cont}
\LeftLabel{var}
\UnaryInfC{z $\in$ $\prod_{z \in Nat}$($\varphi(z)$)[$\Gamma$,z $\in \varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} \prod_ {z \in \varphi(x)} \varphi(succ(x))$]}
\LeftLabel{I-{\scriptsize}$\prod$}
\UnaryInfC{$\lambda$w.$\lambda$z.z $\in$ $\prod_{z \in(\varphi(0) \hspace{0.1cm}\times\hspace{0.1cm} \prod_{x \in Nat} (\prod_ {z \in \varphi(x)} \varphi(succ(x))))}$ $\prod_{z \in Nat}$($\varphi(z)$)[$\Gamma$]}
\end{prooftree}
\end{adjustwidth}
\noindent
\normalsize
