...
$\Rightarrow$ $\lambda z.\lambda w_2.id(w_2)$ $\in$ $\prod_{z \in A}$ $\prod_{w_2 \in Id(A,y,z)}$ $\in$ Id(A,x,z)[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y)]\\
Applico \textit(E-Id$_{dip}$).
...
\LeftLabel{F-Id}
\BinaryInfC{Id(A,x,y) type[x $\in$ A,y $\in$ A]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(w$_1$ $\in$ Id(A,x,y) cont) $\notin$ \\ (x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y))\end{tabular}}
\UnaryInfC{x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y) cont}
\LeftLabel{ind-ty}
\BinaryInfC{A type[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y)]}

\AxiomC{}
\UnaryInfC{A type[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A]}
\AxiomC{}
\UnaryInfC{y $\in$ A[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A]}
\AxiomC{}
\UnaryInfC{z $\in$ A[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A]}
\LeftLabel{F-Id}
\TrinaryInfC{Id(A,y,z) type[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A]}


\AxiomC{}
\UnaryInfC{A type[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A, w_2 $\in$ Id(A,y,z)]}
\AxiomC{}
\UnaryInfC{x $\in$ A[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A, w_2 $\in$ Id(A,y,z)]}
\AxiomC{}
\UnaryInfC{z $\in$ A[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A, w_2 $\in$ Id(A,y,z)]}
\LeftLabel{F-Id}
\TrinaryInfC{Id(A,x,z)[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A, w_2 $\in$ Id(A,y,z)]}
\LeftLabel{F-${\scriptsize\prod}$}
\BinaryInfC{{\scriptsize$\prod$}$_{w_2 \in Id(A,y,z)}$ Id(A,x,z)[x $\in$ A,y $\in$ A,w$_1$ $\in$ Id(A,x,y), z $\in$ A]}
\LeftLabel{F-${\scriptsize\prod}$}
