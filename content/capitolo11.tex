...
\noindent
Supposto che $\varphi$(z) type[$\Delta$, z $\in$ {\scriptsize  $\sum_{x \in B} C(x)$}], C(x) type[$\Delta$, x $\in$ B] siano derivabili e  $\Gamma$ $\equiv$ [ ], allora
\small
...
\\\\\\
Supposto che $\varphi(z_1,z_2,z_3)$ [$\Delta$, z$_1$ $\in$ A, z$_2$ $\in$ A, z$_3$ $\in$ Id(A,z$_1$,z$_2$)] e  A type[$\Delta$] siano derivabili e $\Gamma$ $\equiv$ [ ], allora
\small
