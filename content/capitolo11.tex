...
\LeftLabel{I-{$\times$}}
\BinaryInfC{$<w,k> \in \varphi(0) \times \prod_{x \in Nat}(\prod_{s \in \varphi(x)}\varphi(succ(x)))$ type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(y $\in$ $(<w,k> \in \varphi(0) \times \prod_{x \in Nat}$ \\$(\prod_{s \in \varphi(x)}\varphi(succ(x))))$) $\notin$ $\Gamma$\end{tabular}}
...
\LeftLabel{I-{$\times$}}
\BinaryInfC{$<c,k> \in \varphi(nil) \times {\scriptsize \prod_{x \in List(A)}} {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w)))$ type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(z$^{\backprime\backprime}$ $\in$ $(<c,k> \in \varphi(nil) \times {\scriptsize \prod_{x \in List(A)}}$ \\$ {\scriptsize \prod_{w \in A}}$ $({\scriptsize \prod_{z^\backprime \in \varphi(x)}} \varphi(cons(x,w)))$) $\notin$ $\Gamma$ \end{tabular}}
\UnaryInfC{$\Delta$ cont}
\LeftLabel{var}
\UnaryInfC{c $\in$ $\varphi(nil)$[$\Delta$]}
