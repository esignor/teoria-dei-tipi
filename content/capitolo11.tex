...
\AxiomC{}
\UnaryInfC{$\pi_1$w $\in$ $\psi$ type[z $\in$ B $+$ C,z$^\backprime$ $\in$ B $+$ C,w $\in$ $\phi$]}
\LeftLabel{I-{\scriptsize$\prod$}}
\UnaryInfC{$\lambda$w.$\pi_1$w $\in$ $\prod_{w \in \phi} \psi$ type[z $\in$ B $+$ C,z$^\backprime$ $\in$ B $+$ C]}

\AxiomC{}

\UnaryInfC{$\lambda$w.$\pi_2$w $\in$ ($\prod_{w \in \psi} \phi$) type[z $\in$ B $+$ C,z$^\backprime$ $\in$ B $+$ C}

\LeftLabel{I-x}
\BinaryInfC{$<\lambda w.\pi_1$w,$\lambda$w.$\pi_2$w$>$ $\in$ ($\prod_{w \in \phi} \psi$) $\times$ ($\prod_{w \in \psi} \phi$) type[z $\in$ B $+$ C,z$^\backprime$ $\in$ B $+$ C]}
\end{prooftree}
\end{adjustwidth}
