...
\noindent
Questi \`e dipendente in modo primitivo e definito dalle regole seguenti.
...
\UnaryInfC{z$_1$ $\in$ Nat, z$_2$ $\in$ Nat cont}
\LeftLabel{var}
\UnaryInfC{z$_1$ $\in$ [z$_1$ $\in$ Nat, z$_2$ $\in$ Nat]}
\end{prooftree}
\end{adjustwidth}
...
\UnaryInfC{z$_1$ $\in$ Nat, z$_2$ $\in$ Nat cont}
\LeftLabel{var}
\UnaryInfC{z$_2$ $\in$ [z$_1$ $\in$ Nat, z$_2$ $\in$ Nat]}
\end{prooftree}
\end{adjustwidth}
