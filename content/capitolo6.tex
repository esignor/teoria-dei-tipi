...
\item Conclusioni:
\begin{itemize}
\item El$_{Nat}$(z,c,e) $\equiv$ El$_{Nat}$(x,id(0),(w,x,y).h(x+0,x,y))
...
\AxiomC{\textbf{1}}
\UnaryInfC{Id(Nat,x+0,x)type[x $\in$ Nat]}
\AxiomC{\textbf{2}}
\UnaryInfC{id(0) $\in$ Id(Nat,0+0,0)[ ]}
\AxiomC{\textbf{3}}
\UnaryInfC{h(x+0,x,y) $\in$ Id(Nat,succ(x)+0,succ(x))[x $\in$ Nat,y $\in$ Id(Nat,x+0,x)]}
\LeftLabel{E-Nat$_{dip}$}
\TrinaryInfC{El$_{Nat}$(x,id(0),(w,x,y).h(x+0,x,y))Id(Nat,x+0,x)[x $\in$ Nat]}
\end{prooftree}
\end{adjustwidth}
\vspace{0.5cm}
\normalsize \textbf{1}
...
\UnaryInfC{x $\in$ Nat[x $\in$ Nat]}
\LeftLabel{F-Id}
\TrinaryInfC{Id(Nat,x+0,x)type[x $\in$ Nat]}
\end{prooftree}
...
c $\in$ M(t)[$\Gamma$] $\equiv$ 0 $\in$ Nat[$\Gamma$]
\small
\begin{adjustwidth}{-4em}{}
\begin{prooftree}
\AxiomC{[ ] cont}
...
\vspace{0.5cm}
\normalsize \textbf{3}\\\\
$\Delta$ $\equiv$ x $\in$ Nat,y $\in$ Id(Nat,x+0,x)
\small
\begin{adjustwidth}{-12em}{}
\begin{prooftree}
\AxiomC{\textbf{$\diamondsuit$}}
\UnaryInfC{h(x+0,x,y) $\in$ Id(Nat,succ(x+0),succ(x))[$\Delta$]}
\AxiomC{\textbf{3$^\backprime$}}
\UnaryInfC{Id(Nat,succ(x+0),succ(x)) $=$ Id(Nat,succ(x)+0,succ(x))[$\Delta$]}
\LeftLabel{conv}
\BinaryInfC{h(x+0,x,y) $\in$ Id(Nat,succ(x)+0,succ(x))[$\Delta$]}
\end{prooftree}
\end{adjustwidth}
...
\UnaryInfC{Id(Nat,x+0,x)type[x $\in$ Nat]}
\LeftLabel{F-c}\RightLabel{\begin{tabular}[c]{cc}(y $\in$ Id(Nat,x+0,x))\\ $\notin$ x $\in$ Nat\end{tabular}}
...
\UnaryInfC{succ(x+0) $=$ succ(x)+0 $\in$ Nat[$\Delta$]}


\AxiomC{\textbf{$\bigstar$}}
\UnaryInfC{x $\in$ Nat[$\Delta$]}
\LeftLabel{I$_2$-Nat}
\UnaryInfC{succ(x) $\in$ Nat[$\Delta$]}
\LeftLabel{ref}
\UnaryInfC{succ(x) $=$ succ(x) $\in$ Nat[$\Delta$]}
\LeftLabel{eq-F-Id}
\TrinaryInfC{Id(Nat,succ(x+0),succ(x)) $=$ Id(Nat,succ(x)+0,succ(x))[$\Delta$]}
\end{prooftree}
\end{adjustwidth}
...
El$_{Nat}$(0,c,e) $\equiv$ El$_{Nat}$(0,succ(x+0),(w,z).succ(z))\\
c $\in$ M(t)[$\Gamma$] $\equiv$ succ(x+0) $\in$ Nat[$\Gamma$]
\small
\begin{adjustwidth}{-5em}{}
\begin{prooftree}
...
\UnaryInfC{$\Delta$ cont}
\LeftLabel{ind-te}
\BinaryInfC{x+0 $\in$ Nat[$\Delta$]}
\LeftLabel{I$_2$-Nat}
\UnaryInfC{succ(x+0) $\in$ Nat[$\Delta$]}

\AxiomC{\textbf{$\bigstar$}}
\UnaryInfC{$\Delta$, w $\in$ Nat, z $\in$ Nat cont}
\LeftLabel{var}
\UnaryInfC{z $\in$ Nat[$\Delta$, w $\in$ Nat, z $\in$ Nat]}
\LeftLabel{I$_2$-Nat}
\UnaryInfC{succ(z) $\in$ Nat[$\Delta$, w $\in$ Nat, z $\in$ Nat]}

\LeftLabel{C$_1$-Nat}
\TrinaryInfC{succ(x)+0  $=$ succ(x+0) $\in$ Nat[$\Delta$]}
\LeftLabel{sym}
\UnaryInfC{succ(x+0) $=$ succ(x)+0 $\in$ Nat[$\Delta$]}
...
\textbf{$\heartsuit$} derivazione gi\`a risolta in \S\ref{sec: es-naturali}, esercizio 3.\\
