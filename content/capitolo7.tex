...
\UnaryInfC{C type[$\Gamma$]}
\LeftLabel{F-c}\RightLabel{(y $\in$ C) $\notin$ $\Gamma$}
\UnaryInfC{$\Gamma$,y $\in$ C cont}
\LeftLabel{ind-ty}
\BinaryInfC{B type[$\Gamma$,y $\in$ C]}
\LeftLabel{F-c}\RightLabel{(x $\in$ B) $\notin$ ($\Gamma$, y $\in$ C)}
\UnaryInfC{$\Gamma$,y $\in$ C,x $\in$ B cont}
\LeftLabel{var}
\UnaryInfC{y $\in$ B[$\Gamma$,y $\in$ C,x $\in$ B]}
\AxiomC{($\ast$)}
\UnaryInfC{$\Gamma$,x $\in$ B,y $\in$ C cont}
\LeftLabel{ex-te}
\BinaryInfC{y $\in$ B[$\Gamma$,x $\in$ B,y $\in$ C]}
\LeftLabel{E-$\Sigma_{dip}$}
...
\LeftLabel{$\Sigma$-F}
\UnaryInfC{$\sum\limits_{x \epsilon B}$ $\varphi$(x) type[$\Gamma$]}
\end{prooftree}
\noindent
