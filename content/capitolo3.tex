\chapter{Naturali, Liste e Somma disgiunta}
\label{naturali-somma-liste-disgiunta}
...
\label{sec: tipo-somma-disgiunta}
...
\AxiomC{e$_C$(x$_2$) $\in$ M(inr(x$_2$))[$\Gamma$, x$_2$ $\in$ C]}
\LeftLabel{C$_1$-$+$)}
\TrinaryInfC{El$_+$(inl(b),e$_B$,e$_C$) $\in$ M(t)[$\Gamma$] = e$_B$(b) $\in$ M(inl(b))[$\Gamma$]}
\end{prooftree}
\end{adjustwidth}
\small
\begin{adjustwidth}{-5em}{}
...
\AxiomC{e$_C$(x$_2$) $\in$ M(inr(x$_2$))[$\Gamma$, x$_2$ $\in$ C]}
\LeftLabel{C$_1$-$+$)}
\TrinaryInfC{El$_+$(inr(c),e$_B$,e$_C$) $\in$ M(t)[$\Gamma$] = e$_C$(c) $\in$ M(inr(c))[$\Gamma$]}
\end{prooftree}
\end{adjustwidth}
...
\UnaryInfC{x$^\backprime$ $\in$ List(A), y$^\backprime$ $\in$ A cont}
\LeftLabel{var}
\UnaryInfC{x$^\backprime$ $\in$ List(A)[x$^\backprime$ $\in$ List(A), y$^\backprime$ $\in$ A]}
\end{prooftree}
\vspace{1cm}
\normalsize \textbf{3}
\small
...
\UnaryInfC{y $\in$ List(A), x $\in$ List(A) cont}
\LeftLabel{var}
\UnaryInfC{x $\in$ List(A)[x $\in$ List(A), y $\in$ List(A)]}
\end{prooftree}
\vspace{1cm}
\normalsize \textbf{4}
\small
