...
\begin{center}
\[
\varnothing \hspace{0.1cm} contesto  \qquad \qquad
F-C) \quad \frac{A \hspace{0.1cm} type[\Gamma]}{\Gamma, x\in A \hspace{0.1cm} cont}
\]
\end{center}
...
\[ F-S) \quad \frac{\Gamma\hspace{0.1cm}cont}{N_1\hspace{0.1cm}type[\Gamma]} \]
\\\\
...
\[ F-C) \quad \frac{A\hspace{0.1cm}type[\Gamma]}{\Gamma,\hspace{0.1cm}x \in A}
\quad con \hspace{0.1cm} x\in A \notin \Gamma \]
\subsection{Regole di assunzione delle variabili}
\label{subsec:assunzione-variabili}
\[ var-ass) \quad \frac{\Gamma, x \in A, \Delta \quad cont}{x \in A\hspace{0.1cm}type[\Gamma,x \in A, \Delta]} \]
...
\begin{center}
$\frac{c\hspace{0.1cm} \in [C,\Gamma] \quad b\hspace{0.1cm} \in [B(c),\Gamma] \quad A(x,y)\hspace{0.1cm}type[x \in C, y \in B(x)]}{A(c,b)\hspace{0.1cm}type[\Gamma]}$
\end{center}
\begin{center}
$\frac{c\hspace{0.1cm} \in [C,\Gamma] \quad b\hspace{0.1cm} \in [B(c),\Gamma] \quad A(x,y)\hspace{0.1cm}type[x \in C, y \in B(x)]}{a(c,b) \in A(c,b)\hspace{0.1cm}type[\Gamma]}$
\end{center}
Se si ha un tipo puo' venire usato il giudizio di uguaglianza tra termini e la sostituzione.
\begin{center}
$\frac{A(x)\hspace{0.1cm} type[\Gamma, x \in C] \quad c = e\hspace{0.1cm} \in C[\Gamma]}{A(c) = A(e)\hspace{0.1cm}type[\Gamma]}$
\end{center}
\`E dunque fondamentale il concetto di uguaglianza fra tipi. Se considero che ci sia un elemento
\begin{center}
$\frac{a(x) \in A(x)\hspace{0.1cm} type[\Gamma, x \in C] \quad c = e\hspace{0.1cm} \in C[\Gamma]}{a(c) = a(e) \in A(c)\hspace{0.1cm}type[\Gamma]}$
\end{center}
...
\begin{center}
\[
F-S) \quad \frac{[\Gamma] \hspace{0.1cm} cont}{N1\hspace{0.1cm}type[\Gamma]}
\]
\end{center}
...
\begin{center}
\[
I-S) \quad \frac{[\Gamma] \hspace{0.1cm} cont}{*\in N1 \hspace{0.1cm}type[\Gamma]}
\]
\end{center}
...
\\\\
Le regole (S), (I-S), (E-S) e (C-D)  hanno una spiegazione computazionale, e riguardano la compatibilit\`a tra tipi, ma non da caratterizzare il tipo dei tipi.\\ Inoltre il tipo singoletto non \`e dipendente.
