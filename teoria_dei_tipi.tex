...
\TrinaryInfC{$El_{\textit{T}}$(t, c) $\in$ M(t) type[$\Gamma$]}
\DisplayProof
...
Tali regole sono del tipo k e rispettano la forma\\
\AxiomC{t = s $\in$ N$_1$ type[$\Gamma$]}
\AxiomC{M(z) type[$\Gamma$, z $\in$ N$_1$]}
\AxiomC{c = d $\in$ M(t') type[$\Gamma$]}
\TrinaryInfC{El$_{\textit{T}}$(t', c) = c $\in$ M(t') type[$\Gamma$]}
\DisplayProof
\end{enumerate}
\noindent
...
\item \AxiomC{t$_1$ $\rightarrow$ t$_2$}
\LeftLabel{red$_I$)}
...
\AxiomC{t$_1$ $\rightarrow$ $_1$ t$_2$}
\AxiomC{c$_1$ $\rightarrow$ $_1$ c$_2$}
\BinaryInfC{El$_{N1}$(t$_1$, c$_1$) $\rightarrow$ $_1$ El$_{N1}$(t$_2$, c$_2$)}
\DisplayProof
\end{itemize}
\noindent
...
\end{tabularx}
\caption{\label{tab:tipi-dipendenti}Termini a $\rightarrow$ $_1$ di N$_1$.} 
\end{table}
\noindent
...
\end{itemize}
\noindent
Per ogni teoria \text{T} $\rightarrow$ $_1$ non \`e deterministica.
