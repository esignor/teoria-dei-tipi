...
\begin{equation}
\varnothing \quad contesto  \qquad \qquad
F-C \quad \frac{A type[\Gamma]}{\Gamma, x\in A cont} \label{quinto_giudizio-eq:estensione-contesto}
\end{equation}
Il giudizio in \ref{quinto_giudizio-eq:estensione-contesto} permette di generare i contesti. Tale giudizio, a differenza dei primi quattro, rimane immutato in ogni teoria dei tipi.
